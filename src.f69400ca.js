...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"util.ts":[function(require,module,exports) {
"use strict";
...
},{}],"Tape.tsx":[function(require,module,exports) {
"use strict";
...
},{"react":"../node_modules/react/index.js"}],"prettyPrint.ts":[function(require,module,exports) {
"use strict";
...
},{"./util":"util.ts"}],"index.tsx":[function(require,module,exports) {
"use strict";
...
var prettyPrint_1 = __importDefault(require("./prettyPrint"));
...
function (_super) {
  ...
  function Boof(props) {
    ...
    _this.state = {
      input: '',
      src: prettyPrint_1.default('++++++++[>++++[>++>+++>+++>+<<<<-]>+>+>->>+[<]<-]>>.>---.+++++++..+++.>>.<-.<.+++.------.--------.>>+.>++.'),
      program: null,
      loading: false
    };
    _this.worker = _this.initWorker();
    return _this;
  }

  Boof.prototype.initWorker = function () {
    var _this = this;

    var worker = new Worker("/worker.5da34cf7.js");
  ...
  Boof.prototype.render = function () {
    ...
    var _a = this.state,
        ...
        input = _a.input,
        loading = _a.loading;
    return React.createElement("div", null, React.createElement("header", null, React.createElement("a", {
      href: "https://github.com/brandly/boof"
    }, React.createElement("h1", null, "boof")), program && React.createElement("div", {
      className: "io"
      ...
      onClick: function onClick() {
        var src = prettyPrint_1.default(_this.state.src);
    ...
    }, "pretty"), React.createElement("button", {
      onClick: function onClick() {
        try {
    ...
    }, "save"), loading && React.createElement("span", null, "loading..."))), React.createElement("div", {
      className: "scroll"
    }, React.createElement("div", {
      className: "pane"
      ...
      className: "pane"
    }, program ? this.state.src.split('\n').map(function (_, line) {
      return React.createElement("li", {
        key: line
      }, program.summaries[line] || nbsp);
    }) : null)), program && React.createElement("footer", null, React.createElement(Tape_1.default, {
      state: program.state
    })));
  };
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./util":"util.ts","./Tape":"Tape.tsx","./prettyPrint":"prettyPrint.ts","./worker.tsx":[["worker.5da34cf7.js","worker.tsx"],"worker.5da34cf7.js.map","worker.tsx"]}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
